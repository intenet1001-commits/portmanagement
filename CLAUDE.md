...
- `/check-supabase-columns` — `ports` 테이블 push/pull 컬럼 정합성 감사. push 객체에서 허용되지 않은 컬럼(`ai_name`, `category`, `description`, `worktree_path`) 검출. 파일: `.claude/commands/check-supabase-columns.md`
